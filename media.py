...
class Media():
    ...
    """
    def __init__(self, media_name, media_image, media_release_date,
                 media_length):
        """Inits Media with media_name, media_image, media_release_date,
           and media_length."""
...
class Movie(Media):
    """ This class provides a way to store movie related information
        ...
        Attributes:
            ...
            movie_trailer_youtube: A url reference to the movie trailer on
                                   YouTube
    """
    # This is a constructor
    def __init__(self, media_name, media_image, media_release_date,
                 media_length, movie_storyline, movie_trailer_youtube):
        ...
        Media.__init__(self, media_name, media_image, media_release_date,
                       media_length)
